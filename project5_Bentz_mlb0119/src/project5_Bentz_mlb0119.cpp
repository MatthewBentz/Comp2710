//============================================================================
// Name        : project5_Bentz_mlb0119.cpp
...
int array_function(int array[], int len) {
	int n = 1;
	for (int i = 1; i < len; i++) {
...
int main() {
	int num_array[8] = {32, 10, 15, 92, 72, 13, 26, 11};
	int n = array_function(num_array, 8);
	cout << n << endl;
	return 0;
}
...
// therefore, this project actual will generate at most 10 integers.
#define MAX 10
